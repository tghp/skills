...
The color field interface

The color field settings

## Settings[​](#settings "Direct link to Settings")

Besides the [common settings](https://docs.metabox.io/fields/color/field-settings/), this field has the following specific settings, the keys are for use with code:

| Name                    | Key            | Description                                                                    |
| ----------------------- | -------------- | ------------------------------------------------------------------------------ |
| Allow to select opacity | alpha\_channel | Whether to add opacity to the color picker. true or false (default). Optional. |
| Color picker options    | js\_options    | Extra color picker options. [See here](https://automattic.github.io/Iris/).    |
