...
The post field default interface

The post field with checkbox list interface

The post field with radio list interface

The post field settings

## Settings[​](#settings "Direct link to Settings")

Besides the [common settings](https://docs.metabox.io/fields/post/field-settings/), this field has the following specific settings, the keys are for use with code:

| Name          | Key         | Description                                                                                                                                                           |
| ------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Post types    | post\_type  | Post types to query. Can be a string (for a single post type) or array (for multiple post types). Required.                                                           |
| Query args    | query\_args | Query arguments for getting post objects. Uses the same arguments as [WP\_Query](https://developer.wordpress.org/reference/classes/wp%5Fquery/#parameters). Optional. |
...
| Field type    | field\_type | How the posts are displayed? See below.                                                                                                                               |
...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| select           | Simple select dropdown.                                                                                                                                                                        | [Select](https://docs.metabox.io/fields/post/fields/select/)                   |
| select\_advanced | Beautiful select dropdown using the select2 library. This is the default value.                                                                                                                | [Select advanced](https://docs.metabox.io/fields/post/fields/select-advanced/) |
| select\_tree     | Hierarchical list of select boxes that allows to select multiple items (select/deselect parent item will show/hide child items). Applied only when the post type is hierarchical (like pages). | [Select](https://docs.metabox.io/fields/post/fields/select/)                   |
| checkbox\_list   | Flatten list of checkboxes that allows to select multiple items.                                                                                                                               | [Checkbox list](https://docs.metabox.io/fields/post/fields/checkbox-list/)     |
| checkbox\_tree   | Hierarchical list of checkboxes that allows to select multiple items (select/deselect parent item will show/hide child items). Applied only when the post type is hierarchical (like pages).   | [Checkbox list](https://docs.metabox.io/fields/post/fields/checkbox-list/)     |
| radio\_list      | Flatten list of radio boxes that allows to select only 1 item.                                                                                                                                 | [Radio](https://docs.metabox.io/fields/post/fields/radio/)                     |
...
### Limit the number of posts for pagination[​](#limit-the-number-of-posts-for-pagination "Direct link to Limit the number of posts for pagination")
