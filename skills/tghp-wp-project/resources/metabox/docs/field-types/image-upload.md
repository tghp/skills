...
Besides the [common settings](https://docs.metabox.io/fields/image-upload/field-settings/), this field has the following specific settings, the keys are for use with code:
...
This field inherits from file advanced and thus, uses the [same filters](https://docs.metabox.io/fields/image-upload/fields/file-advanced/) to change the texts displaying on the screen.
