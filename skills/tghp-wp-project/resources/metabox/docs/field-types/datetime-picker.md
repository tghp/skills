...
The datetime field interface

The datetime field settings

## Settings[​](#settings "Direct link to Settings")

Besides the [common settings](https://docs.metabox.io/fields/datetime/field-settings/), this field has the following specific settings, the keys are for use with code:
...
| Date picker options     | js\_options  | Date and picker options. See [date picker options](http://api.jqueryui.com/datepicker) and [time picker options](http://trentrichardson.com/examples/timepicker/). |
...
## Saving dates in another format[​](#saving-dates-in-another-format "Direct link to Saving dates in another format")
...
The 2nd parameter of [rwmb\_the\_value()](https://docs.metabox.io/fields/datetime/functions/rwmb-the-value/) accepts and extra parameter "**format**" which specify the datetime format to output in the frontend.
