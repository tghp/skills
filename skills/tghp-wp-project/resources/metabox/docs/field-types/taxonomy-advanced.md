...
Besides the [common settings](https://docs.metabox.io/fields/taxonomy-advanced/field-settings/), this field has the following specific settings, the keys are for use with code:
...
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| select           | Simple select dropdown.                                                                                                                                                                           | [Select](https://docs.metabox.io/fields/taxonomy-advanced/fields/select/)                   |
| select\_advanced | Beautiful select dropdown using the select2 library. This is the default value.                                                                                                                   | [Select advanced](https://docs.metabox.io/fields/taxonomy-advanced/fields/select-advanced/) |
| select\_tree     | Hierarchical list of select boxes which allows to select multiple items (select/deselect parent item will show/hide child items). Applied only when the taxonomy is hierarchical (like category). | [Select](https://docs.metabox.io/fields/taxonomy-advanced/fields/select/)                   |
| checkbox\_list   | Flatten list of checkboxes which allows to select multiple items.                                                                                                                                 | [Checkbox list](https://docs.metabox.io/fields/taxonomy-advanced/fields/checkbox-list/)     |
| checkbox\_tree   | Hierarchical list of checkboxes which allows to select multiple items (select/deselect parent item will show/hide child items). Applied only when the taxonomy is hierarchical (like category).   | [Checkbox list](https://docs.metabox.io/fields/taxonomy-advanced/fields/checkbox-list/)     |
| radio\_list      | Flatten list of radio boxes which allows to select only 1 item.                                                                                                                                   | [Radio](https://docs.metabox.io/fields/taxonomy-advanced/fields/radio/)                     |
...
Unlike the [taxonomy](https://docs.metabox.io/fields/taxonomy-advanced/fields/taxonomy/) field, this field saves terms' IDs in the database.
