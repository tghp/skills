...
## Basic validation[​](#basic-validation "Direct link to Basic validation")

Meta Box supports [custom attributes](https://docs.metabox.io/validation/custom-attributes/) for all input fields. You can use these attributes to validate the values of fields.
...
If you prefer to [use code to create fields](https://docs.metabox.io/validation/creating-fields-with-code/), add pairs of `'key' => 'value'` rules for the field settings array:
...
## Advanced validation[​](#advanced-validation "Direct link to Advanced validation")
...
If you prefer code, you need to add a key `validation` to the [field group settings](https://docs.metabox.io/validation/creating-fields-with-code/#field-group-settings). This key has a parameter `rules` for validation rules and `messages` for error messages.
...
## Remote validation[​](#remote-validation "Direct link to Remote validation")
