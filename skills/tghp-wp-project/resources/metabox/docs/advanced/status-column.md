...
## Custom post types[​](#custom-post-types "Direct link to Custom post types")

To add status column into the table of the post list of a custom post type, when you [creating that post type](https://docs.metabox.io/status-column/custom-post-types/) with Meta Box, navigate to the **Features** tab, then enable the setting as below:
