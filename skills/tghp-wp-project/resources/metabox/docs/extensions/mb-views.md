...
In this video, we show you step-by-step how to use _MB Views_ to create singular and archive templates for a custom post type. We also show you the basis of Twig and how to set location rules.
...
In the main editor, you can enter any HTML or _shortcodes_ for the template. All shortcodes will be parsed automatically in the front end.

## Insert fields[​](#insert-fields "Direct link to Insert fields")
...
* Site: contains all site fields and settings fields (created by [MB Settings Page](https://docs.metabox.io/extensions/mb-views/extensions/mb-settings-page/) plugin).
* User: contains all user fields and custom fields for users (created by [MB User Meta](https://docs.metabox.io/extensions/mb-views/extensions/mb-user-meta/) plugin).
...
### Main query[​](#main-query "Direct link to Main query")
...
### Cloneable fields[​](#cloneable-fields "Direct link to Cloneable fields")

Cloneable fields are marked with a _repeat_ icon, like this:
...
Inserting sub-fields of cloneable groups
...
Relationships created with [MB Relationships](https://docs.metabox.io/extensions/mb-views/extensions/mb-relationships/) extension can be inserted in the tab **Query**.
...
## Include other views[​](#include-other-views "Direct link to Include other views")
...
## Running PHP functions[​](#running-php-functions "Direct link to Running PHP functions")
...
Relate to the Main query above, if you use the function `get_posts()` or `get_post()`, it will return [post object](https://developer.wordpress.org/reference/classes/wp%5Fpost/).
...
* Shortcode: you need to use a shortcode to insert the view to the location you want. The shortcode is available _after_ you save the view.
* Block: For [MB Blocks](https://docs.metabox.io/extensions/mb-views/extensions/mb-blocks/#using-mb-views), blocks can then use `render: "view:view-name"` to render the view.

### Location Rules[​](#location-rules "Direct link to Location Rules")
...
### `mbv_location_validate`:[​](#mbv%5Flocation%5Fvalidate "Direct link to mbv_location_validate")
...
### `mbv_location_action_active`[​](#mbv%5Flocation%5Faction%5Factive "Direct link to mbv_location_action_active")
...
### `mbv_twig_env`[​](#mbv%5Ftwig%5Fenv "Direct link to mbv_twig_env")
...
### `mbv_data`[​](#mbv%5Fdata "Direct link to mbv_data")
...
## External template files[​](#external-template-files "Direct link to External template files")
...
### Adding template paths[​](#adding-template-paths "Direct link to Adding template paths")
...
### Using external views[​](#using-external-views "Direct link to Using external views")
