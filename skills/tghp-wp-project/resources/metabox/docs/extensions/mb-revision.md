...
## Enabling revision support[​](#enabling-revision-support "Direct link to Enabling revision support")
...
## Comparing the changes[​](#comparing-the-changes "Direct link to Comparing the changes")
...
Clicking either on any revision in the list or on _Browse_ link brings you to the revision comparison screen. There you'll see something like this:
...
Please note that the extension works well with [MB Group](https://docs.metabox.io/extensions/mb-revision/extensions/meta-box-group/) extension.

## Restoring the revision[​](#restoring-the-revision "Direct link to Restoring the revision")
...
Because WordPress supports revision for posts and custom post types only, the extension doesn't work for [term meta](https://docs.metabox.io/extensions/mb-revision/extensions/mb-term-meta/), [user meta](https://docs.metabox.io/extensions/mb-revision/extensions/mb-user-meta/) or [settings pages](https://docs.metabox.io/extensions/mb-revision/extensions/mb-settings-page/).

Please make sure you either not define `WP_POST_REVISIONS` or set it to a proper value in `wp-config.php`. This constant disables or limits the number of revisions. Therefore, it might cause unexprected result. Please see [WordPress Codex](https://codex.wordpress.org/Revisions#Revision%5FOptions) for more information.
