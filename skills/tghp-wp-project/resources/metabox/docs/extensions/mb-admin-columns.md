...
## Showing custom fields as admin columns[​](#showing-custom-fields-as-admin-columns "Direct link to Showing custom fields as admin columns")
...
The instruction above uses [MB Builder](https://docs.metabox.io/extensions/mb-admin-columns/extensions/meta-box-builder/), an extension providing the UI to create fields, and is already bundled in [Meta Box Lite](https://metabox.io/lite/) and [Meta Box AIO](https://docs.metabox.io/extensions/mb-admin-columns/extensions/meta-box-aio/). If you prefer to use code, please see below.
...
## Custom admin columns[​](#custom-admin-columns "Direct link to Custom admin columns")
