...
MB Columns helps you put custom fields into columns in a 12-column grid. You can create nested columns for sub-fields in [groups](https://docs.metabox.io/extensions/meta-box-columns/extensions/meta-box-group/) or put multiple fields into one column.

## Simple syntax[​](#simple-syntax "Direct link to Simple syntax")
...
## Advanced syntax[​](#advanced-syntax "Direct link to Advanced syntax")
