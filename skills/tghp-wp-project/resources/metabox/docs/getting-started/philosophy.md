...
## Plugins-As-Libraries[​](#plugins-as-libraries "Direct link to Plugins-As-Libraries")
...
## Modular[​](#modular "Direct link to Modular")

Meta Box is modular, which means each functionality is separated into an extension. Each extension is a WordPress plugin and can be installed and used independently or together. Extensions can also be used as libraries and you can [bundle them](https://docs.metabox.io/philosophy/bundling/) in your themes or plugins.
