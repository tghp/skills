...
## What are custom post types?[​](#what-are-custom-post-types "Direct link to What are custom post types?")
...
## How to create a custom post type?[​](#how-to-create-a-custom-post-type "Direct link to How to create a custom post type?")

Creating custom post types is done easily with the [MB Custom Post Types & Custom Taxonomies](https://docs.metabox.io/custom-post-types/extensions/mb-custom-post-type/) extension. This extension is already bundled in [Meta Box Lite](https://metabox.io/lite/), [Meta Box AIO](https://docs.metabox.io/custom-post-types/extensions/meta-box-aio/), or you can install it for free from [WordPress.org](https://wordpress.org/plugins/mb-custom-post-type/).
...
To understand the settings in detail, please [see the docs](https://docs.metabox.io/custom-post-types/extensions/mb-custom-post-type/#post-type-settings) for the MB Custom Post Types & Custom Taxonomies extension.

## Creating custom taxonomies[​](#creating-custom-taxonomies "Direct link to Creating custom taxonomies")
...
To understand the settings in details, please [see the docs](https://docs.metabox.io/custom-post-types/extensions/mb-custom-post-type/#taxonomy-settings) for the MB Custom Post Types & Custom Taxonomies extension.
...
After creating a custom post type, let's [add custom fields](https://docs.metabox.io/custom-post-types/custom-fields/) to add more details for posts of that post type! That's the most important part of the whole process and is the heart of Meta Box.
